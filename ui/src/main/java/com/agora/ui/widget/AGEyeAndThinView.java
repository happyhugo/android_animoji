...
public class AGEyeAndThinView extends FrameLayout implements View.OnClickListener {
    ...
    public AGEyeAndThinView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }

    public AGEyeAndThinView(Context context, AttributeSet attrs, int defStyle) {
